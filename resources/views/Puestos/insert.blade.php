...
@section("contenido")
		...
		<div class="form-group row">
		<label class="col-md-4 col-form-label text-md-right">Hora de entrada</label> <input type="time" name="hora_entrada" class="form-control col-md-4" required=""></div>
		<div class="form-group row">
		<label class="col-md-4 col-form-label text-md-right">Hora de salida</label> <input type="time" name="hora_salida" class="form-control col-md-4" required=""></div>
		<div class="form-group row">
